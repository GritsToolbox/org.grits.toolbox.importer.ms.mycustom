...
public class MyMassSpecPropertyWriter implements PropertyWriter
{
	@Override
	public void write(Property property, Element propertyElement) throws IOException {
		if(property instanceof MyCustomMassSpecProperty) {
			MyCustomMassSpecProperty msProperty = (MyCustomMassSpecProperty) property;
